...
export default function HotelStickSearch () {
    ...
    useEffect(() => {  
        ...
        var date1 = new Date(router.query.checkin!=undefined?router.query.checkin:router.query.checkInDate);
        var date2 = new Date(router.query.checkout!=undefined?router.query.checkout:router.query.checkOutDate);
